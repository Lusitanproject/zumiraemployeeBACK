# Migração de Rotas — Backend para Frontend

Todas as rotas abaixo foram alteradas. Rotas não listadas aqui permanecem iguais.
...
- `POST /auth/email` e `POST /auth/verify`
...
- Todas as rotas `/acts` sem prefixo admin
