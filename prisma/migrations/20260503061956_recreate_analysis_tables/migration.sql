-- CreateEnum
CREATE TYPE "BatchStatus" AS ENUM ('completed', 'validating', 'failed', 'in_progress', 'finalizing', 'expired', 'cancelling', 'cancelled');
...
-- CreateTable
CREATE TABLE "act_messages_psychosocial_factors" (
    ...
    CONSTRAINT "act_messages_psychosocial_factors_pkey" PRIMARY KEY ("message_id","factor_id")
);
...
-- AddForeignKey
ALTER TABLE "act_messages_psychosocial_factors" ADD CONSTRAINT "act_messages_psychosocial_factors_message_id_fkey" FOREIGN KEY ("message_id") REFERENCES "act_chapter_messages"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "act_messages_psychosocial_factors" ADD CONSTRAINT "act_messages_psychosocial_factors_factor_id_fkey" FOREIGN KEY ("factor_id") REFERENCES "psychosocial_factors"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "act_messages_psychosocial_factors" ADD CONSTRAINT "act_messages_psychosocial_factors_analysis_batch_id_fkey" FOREIGN KEY ("analysis_batch_id") REFERENCES "company_act_analysis_batches"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
