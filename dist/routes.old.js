...
router.post("/admin/users", isAuthenticated_1.isAuthenticated, new CreateUserController_1.CreateUserController().handle);
router.get("/admin/users/find-by", isAuthenticated_1.isAuthenticated, new FindUserByController_1.FindUserByController().handle);
router.put("/admin/users/:id", isAuthenticated_1.isAuthenticated, new UpdateUserController_1.UpdateUserController().handle);
router.delete("/admin/users/:id", isAuthenticated_1.isAuthenticated, new DeleteUserController_1.DeleteUserController().handle);
router.get("/admin/users", isAuthenticated_1.isAuthenticated, new ListAllUsersController_1.ListAllUsersController().handle);
router.get("/admin/users/:userId", isAuthenticated_1.isAuthenticated, new FindUserController_1.FindUserController().handle);
router.get("/admin/users/company/:companyId", isAuthenticated_1.isAuthenticated, new ListUsersByCompanyController_1.ListUsersByCompanyController().handle);
router.post("/admin/users/create-many", isAuthenticated_1.isAuthenticated, new CreateManyUsersController_1.CreateManyUsersController().handle);
// ROTAS PERFIS
router.get("/admin/roles", isAuthenticated_1.isAuthenticated, new FindAllRolesController_1.FindAllRolesController().handle);
router.get("/admin/roles/:id", isAuthenticated_1.isAuthenticated, new FindRoleController_1.FindRoleController().handle);
router.post("/admin/roles", isAuthenticated_1.isAuthenticated, new CreateRoleController_1.CreateRoleController().handle);
router.put("/admin/roles/:id", isAuthenticated_1.isAuthenticated, new UpdateRoleController_1.UpdateRoleController().handle);
router.delete("/admin/roles/:id", isAuthenticated_1.isAuthenticated, new DeleteRoleController_1.DeleteRoleController().handle);
router.put("/admin/roles/:id/permissions", isAuthenticated_1.isAuthenticated, new SetRolePermissionsController_1.SetRolePermissionsController().handle);
// ROTAS PERMISSOES
router.get("/admin/permissions", isAuthenticated_1.isAuthenticated, new FindAllPermissionsController_1.FindAllPermissionsController().handle);
// ROTAS PSYCHOLOGICAL DIMENSION
router.post("/admin/dimensions", isAuthenticated_1.isAuthenticated, new CreateDimensionController_1.CreateDimensionController().handle);
router.get("/admin/dimensions", isAuthenticated_1.isAuthenticated, new FindAllDimensionController_1.FindAllDimensionsController().handle);
router.get("/admin/dimensions/:psychologicalDimensionId", isAuthenticated_1.isAuthenticated, new FindDimensionController_1.FindDimensionController().handle);
router.put("/admin/dimensions/:psychologicalDimensionId", isAuthenticated_1.isAuthenticated, new EditDimensionController_1.EditDimensionController().handle);
// ROTAS RESULTS
...
router.get("/admin/assessments/results", isAuthenticated_1.isAuthenticated, new FindResultsFilteredController_1.FindResultsFilteredController().handle);
router.get("/admin/assessments/results/download-report", isAuthenticated_1.isAuthenticated, new GenerateExcelReportController_1.GenerateExcelReportController().handle);
...
router.get("/admin/assessments/questions/:assessmentId", isAuthenticated_1.isAuthenticated, new FindQuestionByAssessmentController_1.FindQuestionByAssessmentController().handle);
// ROTAS RESULT RATINGS
router.get("/admin/assessments/ratings/:id", isAuthenticated_1.isAuthenticated, new FindResultRatingsByAssessmentController_1.FindResultRatingsByAssessmentController().handle);
router.put("/admin/assessments/ratings/:id", isAuthenticated_1.isAuthenticated, new UpdateResultRatingsController_1.UpdateResultRatingsController().handle);
// ROTAS ALERTS
...
router.get("/admin/assessments", isAuthenticated_1.isAuthenticated, new FindAllAssessmentsController_1.FindAllAssessmentsController().handle);
...
router.get("/admin/assessments/:id", isAuthenticated_1.isAuthenticated, new AssessmentDetailForAdminController_1.AssessmentDetailForAdminController().handle);
...
router.post("/admin/assessments/duplicate/:id", isAuthenticated_1.isAuthenticated, new DuplicateAssessmentController_1.DuplicateAssessmentController().handle);
...
router.put("/admin/assessments/:id", isAuthenticated_1.isAuthenticated, new UpdateAssessmentController_1.UpdateAssessmentController().handle);
...
router.get("/admin/self-monitoring", isAuthenticated_1.isAuthenticated, new FindAllSelfMonitoringBlocksController_1.ListAllSelfMonitoringBlocksController().handle);
router.post("/admin/self-monitoring", isAuthenticated_1.isAuthenticated, new CreateSelfMonitoringBlockController_1.CreateSelfMonitoringBlocksController().handle);
router.put("/admin/self-monitoring/:id", isAuthenticated_1.isAuthenticated, new EditSelfMonitoringBlockController_1.EditSelfMonitoringBlocksController().handle);
router.get("/admin/self-monitoring/:id", isAuthenticated_1.isAuthenticated, new FindSelfMonitoringBlockController_1.FindSelfMonitoringBlocksController().handle);
...
router.get("/admin/self-monitoring/dimensions/:selfMonitoringBlockId", isAuthenticated_1.isAuthenticated, new FindBySelfMonitoringController_1.FindDimensionByBlockController().handle);
// ROTAS PSYCHOSOCIAL FACTORS
router.get("/admin/psychosocial-factors", isAuthenticated_1.isAuthenticated, new FindAllPsychosocialFactorsController_1.FindAllPsychosocialFactorsController().handle);
router.post("/admin/psychosocial-factors", isAuthenticated_1.isAuthenticated, new CreatePsychosocialFactorController_1.CreatePsychosocialFactorController().handle);
router.get("/admin/psychosocial-factors/:id", isAuthenticated_1.isAuthenticated, new FindPsychosocialFactorController_1.FindPsychosocialFactorController().handle);
router.put("/admin/psychosocial-factors/:id", isAuthenticated_1.isAuthenticated, new UpdatePsychosocialFactorController_1.UpdatePsychosocialFactorController().handle);
router.delete("/admin/psychosocial-factors/:id", isAuthenticated_1.isAuthenticated, new DeletePsychosocialFactorController_1.DeletePsychosocialFactorController().handle);
// ROTAS COMPANY
router.get("/admin/companies", isAuthenticated_1.isAuthenticated, new FindAllCompaniesController_1.FindAllCompaniesController().handle);
router.get("/admin/companies/feedback", isAuthenticated_1.isAuthenticated, new FindAllFeedbacksController_1.FindAllFeedbacksController().handle);
router.get("/admin/companies/:companyId", isAuthenticated_1.isAuthenticated, new FindCompanyController_1.FindCompanyController().handle);
...
router.post("/admin/companies/:id/assessments", isAuthenticated_1.isAuthenticated, new SetCompanyAssessmentsController_1.SetCompanyAssessmentsController().handle);
router.post("/admin/companies", isAuthenticated_1.isAuthenticated, new CreateCompanyController_1.CreateCompanyController().handle);
router.put("/admin/companies/:id", isAuthenticated_1.isAuthenticated, new UpdateCompanyController_1.UpdateCompanyController().handle);
router.post("/admin/companies/:companyId/acts/:actChatbotId/analysis", isAuthenticated_1.isAuthenticated, new GenerateActAnalysisController_1.GenerateActAnalysisController().handle);
router.get("/admin/companies/:companyId/acts/:actChatbotId/analysis", isAuthenticated_1.isAuthenticated, new FindActAnalysisController_1.FindActAnalysisController().handle);
router.get("/admin/companies/:companyId/acts/:actChatbotId/analysis/factors/:factorId/messages", isAuthenticated_1.isAuthenticated, new FindActAnalysisFactorMessagesController_1.FindActAnalysisFactorMessagesController().handle);
router.post("/admin/companies/:companyId/feedback/users", isAuthenticated_1.isAuthenticated, new GenerateAllUserFeedbackController_1.GenerateAllUserFeedbackController().handle);
// ROTAS NATIONALITY
router.get("/nationalities", new ListNationalitiesController_1.ListNationalitiesController().handle);
router.post("/admin/nationalities", isAuthenticated_1.isAuthenticated, new CreateNationalityController_1.CreateNationalityController().handle);
router.get("/admin/nationalities", isAuthenticated_1.isAuthenticated, new FindAllNationalitiesController_1.FindAllNationalitiesController().handle);
router.get("/admin/nationalities/:id", isAuthenticated_1.isAuthenticated, new FindNationalityController_1.FindNationalityController().handle);
router.put("/admin/nationalities/:id", isAuthenticated_1.isAuthenticated, new UpdateNationalityController_1.UpdateNationalityController().handle);
// ROTAS NOTIFICATION
...
router.get("/admin/notifications", isAuthenticated_1.isAuthenticated, new FindAllNotificationsController_1.FindAllNotificationsController().handle);
router.get("/admin/notifications/types", isAuthenticated_1.isAuthenticated, new FindAllTypesController_1.FindAllTypesController().handle);
router.get("/admin/notifications/types/:id", isAuthenticated_1.isAuthenticated, new FindNotificationTypeController_1.FindNotificationTypeController().handle);
...
router.put("/admin/notifications/:notificationId", isAuthenticated_1.isAuthenticated, new UpdateNotificationController_1.UpdateNotificationController().handle);
...
router.put("/admin/notifications/types/:id", isAuthenticated_1.isAuthenticated, new UpdateNotificationTypeController_1.UpdateNotificationTypeController().handle);
router.post("/admin/notifications", isAuthenticated_1.isAuthenticated, new CreateNotificationController_1.CreateNotificationController().handle);
router.post("/admin/notifications/types", isAuthenticated_1.isAuthenticated, new CreateNotificationTypeController_1.CreateNotificationTypeController().handle);
router.delete("/admin/notifications/:notificationId", isAuthenticated_1.isAuthenticated, new DeleteNotificationController_1.DeleteNotificationController().handle);
// ROTAS ACTS
router.get("/admin/acts", isAuthenticated_1.isAuthenticated, new FindAllActChatbotsController_1.FindAllActChatbotsController().handle);
router.get("/admin/acts/by-trail", isAuthenticated_1.isAuthenticated, new FindByTrailController_1.FindByTrailController().handle);
router.get("/admin/acts/by-company", isAuthenticated_1.isAuthenticated, new FindByCompanyController_1.FindByCompanyController().handle);
router.get("/admin/acts/:id", isAuthenticated_1.isAuthenticated, new FindActChatbotController_1.FindActChatbotController().handle);
router.put("/admin/acts/update-many", isAuthenticated_1.isAuthenticated, new UpdateManyActChatbotsController_1.UpdateManyActChatbotsController().handle);
router.put("/admin/acts/:id", isAuthenticated_1.isAuthenticated, new UpdateActChatbotController_1.UpdateActChatbotController().handle);
router.post("/admin/acts", isAuthenticated_1.isAuthenticated, new CreateActChatbotController_1.CreateActChatbotController().handle);
router.post("/admin/acts/:id/import-chatbase-chapters", isAuthenticated_1.isAuthenticated, new ImportChatbaseChaptersController_1.ImportChatbaseChaptersController().handle);
...
router.post("/admin/trails", isAuthenticated_1.isAuthenticated, new CreateTrailController_copy_1.CreateTrailController().handle);
router.get("/admin/trails", isAuthenticated_1.isAuthenticated, new FindAllTrailsController_1.FindAllTrailsController().handle);
router.get("/admin/trails/:id", isAuthenticated_1.isAuthenticated, new FindTrailController_1.FindTrailController().handle);
router.put("/admin/trails/:id", isAuthenticated_1.isAuthenticated, new UpdateTrailController_1.UpdateTrailController().handle);
// ROTAS INTEGRATIONS
