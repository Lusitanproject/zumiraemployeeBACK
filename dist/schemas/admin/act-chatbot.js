...
exports.ImportChatbaseChaptersSchema = exports.FindByCompanySchema = exports.FindByTrailSchema = exports.UpdateManyActChatbotsSchema = exports.UpdateActChatbotSchema = exports.CreateActChatbotSchema = void 0;
...
exports.FindByCompanySchema = zod_1.z.object({
    companyId: zod_1.z.string().cuid(),
});
exports.ImportChatbaseChaptersSchema = zod_1.z.object({
    chatbaseChatbotId: zod_1.z.string().nonempty(),
});
