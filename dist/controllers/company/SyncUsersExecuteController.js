...
exports.SyncUsersExecuteController = void 0;
...
class SyncUsersExecuteController {
    async handle(req, res) {
        ...
        const result = await new UserService_1.UserService().executeSync(parsedParams.data.id, parsedBody.data.users);
        return res.json({ status: "SUCCESS", data: result });
    }
}
exports.SyncUsersExecuteController = SyncUsersExecuteController;
